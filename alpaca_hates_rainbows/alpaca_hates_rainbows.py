...
=======
    alpaca_speed = 0.3
>>>>>>> 6cae9d53c10aaa5e285b7e8d1715b3bb1f1df3e4
    alpaca_x = 0
    alpaca_y = 0
...
>>>>>>> 6cae9d53c10aaa5e285b7e8d1715b3bb1f1df3e4
            ...
            for rb in rainbow_list :
<<<<<<< HEAD
                if rb.y>alpaca_y_pos+5 and rb.y<alpaca_y_pos+alpaca_height-5 :
                    if (rb.x>alpaca_x_pos+5 and rb.x<alpaca_x_pos+alpaca_width-5) or\
                    (rb.x+rainbow_width>alpaca_x_pos+5 and rb.x+rainbow_width<alpaca_x_pos+alpaca_width-5) :
=======
